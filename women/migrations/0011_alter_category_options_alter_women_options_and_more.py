# Generated by Django 4.2.1 on 2024-04-29 20:10
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('women', '0010_remove_women_m_count_husband_m_count'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='category',
            options={'verbose_name': '⚜️ Категория', 'verbose_name_plural': '⚜️ Категории'},
        ),
        migrations.AlterModelOptions(
            name='women',
            options={'ordering': ['-time_create'], 'verbose_name': '✨️ Известные женщины', 'verbose_name_plural': '✨️ Известные женщины'},
        ),
